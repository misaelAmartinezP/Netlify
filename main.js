...
function parceoDatos(string) {
    ...
    queryCtas = "set identity_insert CtbCuentas on insert into CtbCuentas(idCuenta,Cuenta,Descripcion,idTipoCuenta,Acepta_Mov,EsProveedor,EsCliente,ToparChequeVsSaldo,EmisionCheque,idCuentaComplementaria,EsDolares,idTipoMoneda,PermitirDeposito,EsDeudor,SaldoLimiteDeudor,EsAcreedor,EsCuentaIVA,IdConceptoDIOT,PermitirProgramarPago,IdAgaCatIVA,IdCtaCostoTAC,IdAgrupadorSAT,Agrupador) values(" + guardaCtaConta1 + "," + guardaCtaConta2 + ",'" + guardaRaSo + "',1,1,0,0,1,0,'NULL',0,6,0,0,0,0,0,'NULL',0,'NULL','NULL','NULL','NULL') set identity_insert AcProveedores off "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             //(9999, 'ROSHERJOSEMXN', 'JOSE ALFREDO ROSAS HERNANDEZ', NULL, 2, 'ROHA711201IJ7', 1, 'PUCCINI, 85 B, ALTOS 2 HAB', 'VALLEJO', '07870', 'GUSTAVO A MADERO', 'NULL', 'NULL', 'NULL', 0, 0, 0, 0, 0, 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 6, 'JOSE ALFREDO', 'ROSAS', 'HERNANDEZ', 'NULL', 'NULL', 'NULL', 0, 'NULL', 'NULL', 0, 31421, 31422, NULL, NULL, 0, '123456987562145962', 'BBVA BANCOMER',                                                                                                                                                                                                            '1', '4', '0', 'NULL', 'NULL', NULL, 0, '897698',                                                4, 'MXN', '012', '', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 6853, NULL, 'NULL', 'NULL', NULL, NULL)
    console.log(queryCtas);
    queryAnt = "set identity_insert CtbCuentas on insert into CtbCuentas(idCuenta,Cuenta,Descripcion,idTipoCuenta,Acepta_Mov,EsProveedor,EsCliente,ToparChequeVsSaldo,EmisionCheque,idCuentaComplementaria,EsDolares,idTipoMoneda,PermitirDeposito,EsDeudor,SaldoLimiteDeudor,EsAcreedor,EsCuentaIVA,IdConceptoDIOT,PermitirProgramarPago,IdAgaCatIVA,IdCtaCostoTAC,IdAgrupadorSAT,Agrupador) values(" + guardaCtaAnt1 + "," + guardaCtaAnt2 + ",'" + guardaRaSo + "',4,1,1,0,0,1,'NULL',0,6,0,0,0,0,0,'NULL',0,'NULL','NULL','NULL','NULL') set identity_insert AcProveedores off "
    console.log(queryAnt);
    query = "set identity_insert AcProveedores on + CHAR(13) + CHAR(10) insert into AcProveedores(idProveedor, Codigo, RazonSocial, idGiro, idTipoProveedor, Rfc, idCiudad, Direccion, Colonia, CodPost, Delegacion, Telefono, Fax, Mail, LimiteCredito, DiasCredito, DiasEntrega, CalifPuntualidad, CalifCalidad, Contacto, NombreJefe, PuestoJefe, Observaciones, RegistroPatronal, RegistroCamara, Infonavit, TipoFiscal, idTipoMoneda, Nombre, ApellidoPaterno, ApellidoMaterno, Celular, PaginaWeb, CondicionesPago, PersonaMoral, CURP, PersonasAtiendenPedidos, Suspendido, IdCuentaProveedor, IdCuentaAnticipo, IdCuentaFonGar, IdCuentaDeudor, ConPagoElectronico, CLABE, Banco, IdTipoTerceros, IdTipoOperacion, GastosFinancieros, ClaveCliente, CodigoSAP, IdAgaCatAcreedor, PermitirExentoIVA, CuentaBancaria, IdBancoSAT, MonedaSATDefault, BancoSAT, TipoDeCuentaCASH, ConceptoCIECASH, ReferenciaCIECASH, ConvenioCIECASH, NumRegIdFiscal, PlazaBanxico, IdPais, IdClaveTransferencia, Nacionalidad, Sucursal, IdCuentaPagoEnEspecie, IdCuentaOtrasRetenciones) + CHAR(13) + CHAR(10)values(9999,'" + guradaGenCod + "','" + guardaRaSo + "',NULL,2,'" + guardaRFC + "','" + guardaIdCiudad + "','" + guardaNomVia + ", " + guardaNumExt + ", " + guardaNumInt + "','" + guardaNomCol + "','" + guardaCodPos + "','" + guardaDemTer + "'" + ",'NULL', 'NULL', 'NULL', 0, 0, 0, 0, 0, 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', '6','" + guardaPersonaFisNom + "','" + gaurdaPersonaFisApPa + "', '" + gaurdaPersonaFisApMa + "', 'NULL', 'NULL', 'NULL'," + guardaPersonaMoral + ", 'NULL', 'NULL', 0, " + guardaCtaConta1 + ", " + guardaCtaAnt1 + ", 'NULL', 'NULL', 0,'" + guardaClabe + "','" + guardaBanco + "', '1', '4', '0', 'NULL', 'NULL', 'NULL', 0, '" + guardaCtaBancaria + "','" + guardaIdBancoSat + "','MXN','" + guardaBancoSat + "', '', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', '6853', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL') set identity_insert AcProveedores off  + CHAR(13) + CHAR(10)+" +queryCtas + "+ CHAR(13) + CHAR(10)"+ queryAnt + ";"
