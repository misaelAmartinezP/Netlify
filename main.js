...
function parceoDatos(string) {
    ...
    guardaTipOracion = descripcionTipOracion(gaurdaPersonaFisApPa, gaurdaPersonaFisApMa, guardaPersonaFisNom, guardaRaSo, guardaRFC)//tipo oracion
    consolo.log(guardaTipOracion);
