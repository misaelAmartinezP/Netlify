...
function querysCtas(string, gaurdaPersonaFisApPa, gaurdaPersonaFisApMa, guardaPersonaFisNom, guardaCtaConta1, guardaCtaConta2, guardaCtaAnt1, guardaCtaAnt2, guardaRaSo) {
    rfc = string;
    queryCtasContAnt = "";
    if ((rfc.length) == 12) {//si es persona moral
        queryCtas = "set identity_insert CtbCuentas on insert into CtbCuentas(idCuenta,Cuenta,Descripcion,idTipoCuenta,Acepta_Mov,EsProveedor,EsCliente,ToparChequeVsSaldo,EmisionCheque,idCuentaComplementaria,EsDolares,idTipoMoneda,PermitirDeposito,EsDeudor,SaldoLimiteDeudor,EsAcreedor,EsCuentaIVA,IdConceptoDIOT,PermitirProgramarPago,IdAgaCatIVA,IdCtaCostoTAC,IdAgrupadorSAT,Agrupador) \n values(" + guardaCtaConta1 + "," + guardaCtaConta2 + ",'" + guardaRaSo + "',1,1,0,0,1,0,'NULL',0,6,0,0,0,0,0,'NULL',0,'NULL','NULL','NULL','NULL') \n set identity_insert AcProveedores off "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             //(9999, 'ROSHERJOSEMXN', 'JOSE ALFREDO ROSAS HERNANDEZ', NULL, 2, 'ROHA711201IJ7', 1, 'PUCCINI, 85 B, ALTOS 2 HAB', 'VALLEJO', '07870', 'GUSTAVO A MADERO', 'NULL', 'NULL', 'NULL', 0, 0, 0, 0, 0, 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 6, 'JOSE ALFREDO', 'ROSAS', 'HERNANDEZ', 'NULL', 'NULL', 'NULL', 0, 'NULL', 'NULL', 0, 31421, 31422, NULL, NULL, 0, '123456987562145962', 'BBVA BANCOMER',                                                                                                                                                                                                            '1', '4', '0', 'NULL', 'NULL', NULL, 0, '897698',                                                4, 'MXN', '012', '', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 6853, NULL, 'NULL', 'NULL', NULL, NULL)
        console.log(queryCtas);
        queryAnt = "\n set identity_insert CtbCuentas on insert into CtbCuentas(idCuenta,Cuenta,Descripcion,idTipoCuenta,Acepta_Mov,EsProveedor,EsCliente,ToparChequeVsSaldo,EmisionCheque,idCuentaComplementaria,EsDolares,idTipoMoneda,PermitirDeposito,EsDeudor,SaldoLimiteDeudor,EsAcreedor,EsCuentaIVA,IdConceptoDIOT,PermitirProgramarPago,IdAgaCatIVA,IdCtaCostoTAC,IdAgrupadorSAT,Agrupador) \n values(" + guardaCtaAnt1 + "," + guardaCtaAnt2 + ",'" + guardaRaSo + "',4,1,1,0,0,1,'NULL',0,6,0,0,0,0,0,'NULL',0,'NULL','NULL','NULL','NULL') \n set identity_insert AcProveedores off "
        console.log(queryAnt);
        pm = queryCtas + queryAnt;
    } if ((rfc.length) == 13) {//si es persona fisica
        queryCtas = "set identity_insert CtbCuentas on insert into CtbCuentas(idCuenta,Cuenta,Descripcion,idTipoCuenta,Acepta_Mov,EsProveedor,EsCliente,ToparChequeVsSaldo,EmisionCheque,idCuentaComplementaria,EsDolares,idTipoMoneda,PermitirDeposito,EsDeudor,SaldoLimiteDeudor,EsAcreedor,EsCuentaIVA,IdConceptoDIOT,PermitirProgramarPago,IdAgaCatIVA,IdCtaCostoTAC,IdAgrupadorSAT,Agrupador) \n values(" + guardaCtaConta1 + "," + guardaCtaConta2 + ",'" + gaurdaPersonaFisApPa + " " + gaurdaPersonaFisApMa + " " + guardaPersonaFisNom + "',1,1,0,0,1,0,'NULL',0,6,0,0,0,0,0,'NULL',0,'NULL','NULL','NULL','NULL') \n set identity_insert AcProveedores off "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             //(9999, 'ROSHERJOSEMXN', 'JOSE ALFREDO ROSAS HERNANDEZ', NULL, 2, 'ROHA711201IJ7', 1, 'PUCCINI, 85 B, ALTOS 2 HAB', 'VALLEJO', '07870', 'GUSTAVO A MADERO', 'NULL', 'NULL', 'NULL', 0, 0, 0, 0, 0, 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 6, 'JOSE ALFREDO', 'ROSAS', 'HERNANDEZ', 'NULL', 'NULL', 'NULL', 0, 'NULL', 'NULL', 0, 31421, 31422, NULL, NULL, 0, '123456987562145962', 'BBVA BANCOMER',                                                                                                                                                                                                            '1', '4', '0', 'NULL', 'NULL', NULL, 0, '897698',                                                4, 'MXN', '012', '', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 6853, NULL, 'NULL', 'NULL', NULL, NULL)
        console.log(queryCtas);
        queryAnt = "\n set identity_insert CtbCuentas on insert into CtbCuentas(idCuenta,Cuenta,Descripcion,idTipoCuenta,Acepta_Mov,EsProveedor,EsCliente,ToparChequeVsSaldo,EmisionCheque,idCuentaComplementaria,EsDolares,idTipoMoneda,PermitirDeposito,EsDeudor,SaldoLimiteDeudor,EsAcreedor,EsCuentaIVA,IdConceptoDIOT,PermitirProgramarPago,IdAgaCatIVA,IdCtaCostoTAC,IdAgrupadorSAT,Agrupador) \n values(" + guardaCtaAnt1 + "," + guardaCtaAnt2 + ",'" + gaurdaPersonaFisApPa + " " + gaurdaPersonaFisApMa + " " + guardaPersonaFisNom + "',4,1,1,0,0,1,'NULL',0,6,0,0,0,0,0,'NULL',0,'NULL','NULL','NULL','NULL') \n set identity_insert AcProveedores off "
        console.log(queryAnt);
