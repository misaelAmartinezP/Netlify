...
function creaGenCod(string, string1) {
    ...
    if ((difPer) == 12) {//si es persona moral
        ...
        if ((arrAux.length) == 4) {
            ...
            //arrAux[2].substring(0, 3);
            console.log(arrAux[2]);
            //arrAux[3].substring(0, 4);
            console.log(arrAux[3]);
        }
